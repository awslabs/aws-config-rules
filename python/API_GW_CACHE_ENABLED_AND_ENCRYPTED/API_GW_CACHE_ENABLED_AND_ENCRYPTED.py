...
Scenarios:
  Scenario: 1
     Given: The API GW stage caching is not enabled
      Then: Return NON_COMPLIANT
  Scenario: 2
     Given: The API GW stage caching is enabled
       And: The API GW stage caching is not encrypted
      Then: Return NON_COMPLIANT
  Scenario: 3
     Given: The API GW stage caching is enabled
       And: The API GW stage caching is encrypted
