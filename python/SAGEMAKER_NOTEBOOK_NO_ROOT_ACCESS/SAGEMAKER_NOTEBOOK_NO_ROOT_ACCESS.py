...
#####################################
Rule Name:
    SAGEMAKER_NOTEBOOK_NO_ROOT_ACCESS
Description:
  Check whether root access is disabled for an Amazon SageMaker Notebook Instance.
Trigger:
  Periodic
Reports on:
  AWS::::Account
...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    ...
    for notebook_instance in notebook_instance_list:
        ...
        if notebook_instance_description.get('RootAccess') == 'Disabled':
