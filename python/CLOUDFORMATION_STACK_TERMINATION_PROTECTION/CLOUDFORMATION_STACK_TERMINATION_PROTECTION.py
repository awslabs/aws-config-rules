...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    ...
    #Get enableTerminationProtection status from CI
    stack_termination_protection_enabled = configuration_item['configuration']['enableTerminationProtection']
    #print("stack id: " + configuration_item['resourceId'])
    
    if stack_termination_protection_enabled:
        #Scenario 1: enableTerminationProtection is True, Stack is protected, Rule COMPLIANT
        return build_evaluation_from_config_item(configuration_item, 'COMPLIANT')
    else:
        #Scenario 2: enableTerminationProtection is False, Stack is NOT protected, Rule NON_COMPLIANT
        return build_evaluation_from_config_item(configuration_item, 'NON_COMPLIANT', annotation='Termination Protection is Disabled for this Stack.')
