...
Description:
  Checks whether Amazon EC2 instances are running on dedicated host but running as License Included, rather than BYOL. The rule is NON_COMPLIANT if the EC2 instance tenancy is set to HOST and the instance usageOperation does not match a BYOL code.
  For more information see: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/billing-info-fields.html
Trigger:
...
Scenarios:
  Scenario: 1
     Given: The tenancy field is set to 'host' in the Amazon EC2 instance configuration item.
     And: The usageOperation field is set to one of: 'RunInstances:0800', 'RunInstances:00g0'
     Then: Return COMPLIANT
  Scenario: 2
     Given: The tenancy field is set to 'host' in the Amazon EC2 instance configuration item.
     And: The usageOperation field is NOT set to one of: 'RunInstances:0800', 'RunInstances:00g0'
     Then: Return NON_COMPLIANT
  Scenario: 3
     Given: The tenancy field is not set to 'host' in the Amazon EC2 instance configuration item.
...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    ...
    """
    # If EC2 instance tenancy set to host and usage-operation set to one of 'RunInstances:0800', 'RunInstances:00g0', return COMPLIANT
    if configuration_item['configuration']['placement']['tenancy'] == 'host' and configuration_item['configuration']['usageOperation'] in ['RunInstances:0800', 'RunInstances:00g0']:
        return build_evaluation(configuration_item['resourceId'], 'COMPLIANT', event)
    # If EC2 instance tenancy set to host and usage-operation not set to one of 'RunInstances:0800', 'RunInstances:00g0', return NON_COMPLIANT
    if configuration_item['configuration']['placement']['tenancy'] == 'host' and configuration_item['configuration']['usageOperation'] not in ['RunInstances:0800', 'RunInstances:00g0']:
        return build_evaluation(configuration_item['resourceId'], 'NON_COMPLIANT', event, annotation='EC2 instance tenancy set to host and usage-operation not set to one of: "RunInstances:0800", "RunInstances:00g0"')
