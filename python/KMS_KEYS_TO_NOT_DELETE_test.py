...
class ComplianceTest(unittest.TestCase):
    ...
    def test_scenario_2_invalid_param(self):
    ...
    def test_scenario_5_param_givdn(self):
    ...
    def test_scenario_6_noncomplaint(self):
    ...
    def test_scenario_7_complaint(self):
        rule_param = "{\"kmsKeyIds\":\"83de41d6-6530-49c1-9cb7-1de1560ce5tg\"}"
        KMS_CLIENT_MOCK.list_keys = MagicMock(return_value=self.kms_key_list)
        KMS_CLIENT_MOCK.describe_key = MagicMock(return_value={"KeyMetadata": {"KeyState": "Enable", "Origin": "AWS_KMS", "KeyManager": "CUSTOMER"}})
        lambda_event = build_lambda_scheduled_event(rule_parameters=rule_param)
        response = RULE.lambda_handler(lambda_event, {})
        resp_expected = []
        resp_expected.append(build_expected_response('COMPLIANT', '83de41d6-6530-49c1-9cb7-1de1560ce5tg', 'AWS::KMS::Key'))
