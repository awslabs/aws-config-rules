...
Rule Name:
  api-gw-restapi-noauth-method.

Description:
  Check all HTTP methods and evaluate as Non Compliant if any of the methods does not have Authorization in place..
...
Feature:
    In order to: to limit the access to API
         ...
         I want: To ensure that all my HTTP methods on my Rest API Gateway have an authentication method in place.

Scenarios:
    Scenario 1:
      Given: All Methods in an API Gateway have 'authorizationType' set as 'NONE'
       Then: return NON_COMPLIANT

    Scenario 2:
      Given: At least one of the Methods in an API Gateway have 'authorizationType' set as 'NONE'
       Then: return NON_COMPLIANT

    Scenario 3:
      Given: All Methods in an API Gateway have 'authorizationType' set up different from 'NONE'
       Then: return COMPLIANT

    Scenario 4:
      Given: No methods present in an API
       Then: return COMPLIANT
...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    ...
    a string -- either COMPLIANT or NON_COMPLIANT
