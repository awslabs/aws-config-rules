...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    ...
    raise Exception("Unknown status of the VGW")  # throwing pylint error Either all return statements in a function should return an expression, or none of them should without this
