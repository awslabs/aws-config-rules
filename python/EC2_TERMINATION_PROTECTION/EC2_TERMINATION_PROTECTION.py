...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    ...
    # Get instance ID from CI
    instance_id = configuration_item['resourceId']

    # Describe EC2 Attributes for this Instance to get DisableApiTermination Value True|False
    # False = NON_COMPLIANT
    # True = COMPLIANT
    ...
    termination_status = attributes['DisableApiTermination']['Value']

    # Scenario 1: EC2 Termination Protection is Enabled, Rule is COMPLIANT
    if termination_status:
        return build_evaluation_from_config_item(configuration_item, 'COMPLIANT')
    else:
        # Scenario 1: EC2 Termination Protection is Enabled, Rule is COMPLIANT
        return build_evaluation_from_config_item(configuration_item, 'NON_COMPLIANT', annotation='This EC2 Instance does not have EC2 Termination Protection enabled.')
