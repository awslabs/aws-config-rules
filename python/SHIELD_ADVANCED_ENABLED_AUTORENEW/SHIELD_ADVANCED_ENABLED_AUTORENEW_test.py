...
RULE = __import__('SHIELD_ADVANCED_ENABLED_AUTORENEW')

class NonCompliantTest(unittest.TestCase):
    def test_scenario_1(self):
        SHIELD_CLIENT_MOCK.describe_subscription = MagicMock(side_effect=
