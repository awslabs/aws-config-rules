...
RULE = __import__("REDSHIFT_USER_ACTIVITY_MONITORING_ENABLED")
...
class ComplianceTest(unittest.TestCase):
    ...
    # Unit test for  enable_user_activity_logging is set to false -- GHERKIN Scenario 2
    def test_scenario_2(self):
        ...
        expected_response = [
            build_expected_response(
                "NON_COMPLIANT",
                "redshift-cluster-1",
                annotation="enable_user_activity_logging is not enforced for the "
                "cluster. Make sure to enable "
                "enable_user_activity_logging by setting it to true and"
                " make sure the parameters are synced.",
            )
        ]
        assert_successful_evaluation(self, response, expected_response)

    # Unit test for enable_user_activity_monitoring is set to true but LoggingEnabled is set to False
    # -- GHERKIN Scenario 3
    def test_scenario_3(self):
        ...
        expected_response = [
            build_expected_response(
                ...
                "Without audit logging enabled, you cannot track user "
                "activity.",
            )
        ]
        assert_successful_evaluation(self, response, expected_response)

    # Unit test for  both enable_user_activity_logging and LoggingEnabled is set to true -- GHERKIN Scenario 4
    ...
    # Unit test when enable_user_activity_logging is set to true, but parameter list is not synced.
    # -- GHERKIN Scenario 4
    def test_scenario_5(self):
        ...
        expected_response = [
            build_expected_response(
                ...
                annotation="enable_user_activity_logging is not enforced for the"
                " cluster. Make sure to enable"
                " enable_user_activity_logging by setting it to true "
                "and make sure the parameters are synced.",
            )
        ]
        assert_successful_evaluation(self, response, expected_response)
