...
RULE = __import__("REDSHIFT_SSL_REQUIRED")
...
class ComplianceTest(unittest.TestCase):
    ...
    def test_scenario_2(self):
        ...
        expected_response = [
            build_expected_response(
                "NON_COMPLIANT",
                "redshift-cluster-1",
                annotation="SSL/TLS is not enforced for the cluster. "
                "Make sure to enable require_ssl by setting it "
                "to true and ensure the parameters are synced.",
            )
        ]
        assert_successful_evaluation(self, response, expected_response)

    # Unit test for  require_ssl is set to true -- GHERKIN Scenario 3
    ...
    # Unit test when require_ssl is set to true, but parameter list is not synced. -- GHERKIN Scenario 4
