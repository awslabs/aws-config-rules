...
RULE = __import__("REDSHIFT_FIPS_REQUIRED")
...
class ComplianceTest(unittest.TestCase):
    ...
    # Unit test for  require_ssl is set to false -- GHERKIN Scenario 2
    def test_scenario_2(self):
        ...
        expected_response = [
            build_expected_response(
                "NON_COMPLIANT",
                "redshift-cluster-1",
                annotation="SSL is not enforced for the cluster. "
                "Make sure to enable require_ssl by setting it to"
                " true prior to forcing FIPS and ensure the "
                "parameters are in sync.",
            )
        ]
        assert_successful_evaluation(self, response, expected_response)

    # Unit test for  use_fips is set to false but require_ssl is set to true -- GHERKIN Scenario 3
    def test_scenario_3(self):
                ...
                "Clusters": [
                    {
                        ...
                        "PubliclyAccessible": False,
                        "Encrypted": False,
                        "ClusterPublicKey": "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABAQCanvmYtbNIGA5PiAY4rF6ppg1wR3QY0f860EPUpRSaoc07U"
                        "HOV4S2QLk21m5KEQm15rTE6dxVWrkXBzNabgdAsuiAo+Abur3D3y8xSZSTMpD4e0Kn3UQ9nKw/2WWKWslNjKy"
                        "zsBRSHv0jdVgg7KjtxoKAYNu/PbH4WCv2bcX+2nz8jxxDg2IOS/A6I3D3pha9Q/FX0MMPYDKwKWw4TZ83PsZ"
                        "QvGWkW37TKaiGHFUpRfpuL/W8gHVD0ZJo8cK+WBxQsG5CujHlyifMQPBGmKiFW8IeHS2evKzPAqIUlUTUA/t"
                        "8t7EeCw5rnby8raUj7qWbeGqJ55d9CjcndHgaY5TZV Amazon-Redshift\n",
                        "ClusterNodes": [
                            {
                                "NodeRole": "LEADER",
                                "PrivateIPAddress": "172.31.34.184",
                        ...
                        "IamRoles": [
                            {
                                "IamRoleArn": "arn:aws:iam::529010877102:role/service-role/AmazonRedshift-CommandsAccessRol"
                                "e-20211209T063611",
                                "ApplyStatus": "in-sync",
                            }
                        ],
                        ...
                        "NextMaintenanceWindowStartTime": "datetime.datetime(2022, 2, 16, 8, 30, tzinfo=tzlocal())",
                        "AvailabilityZoneRelocationStatus": "disabled",
                        "ClusterNamespaceArn": "arn:aws:redshift:us-east-2:529010877102:namespace:95b46b68-0afa-4ca9-baf2-b6bf714"
                        "431bc",
                        "TotalStorageCapacityInMegaBytes": 256000000,
                        "AquaConfiguration": {
                            "AquaStatus": "disabled",
        ...
        expected_response = [
            build_expected_response(
                "NON_COMPLIANT",
                "redshift-cluster-1",
                annotation="FIPS is not enforced for the cluster. Make sure to "
                "enable require_ssl by setting it to true.",
            )
        ]
        assert_successful_evaluation(self, response, expected_response)

    # Unit test for  both use_fips and require_ssl is set to true -- GHERKIN Scenario 4
                ...
                "Clusters": [
                    {
                        ...
                        "PubliclyAccessible": False,
                        "Encrypted": False,
                        "ClusterPublicKey": "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABAQCanvmYtbNIGA5PiAY4rF6ppg1wR3QY0f860EPUpRSaoc"
                        "07UHOV4S2QLk21m5KEQm15rTE6dxVWrkXBzNabgdAsuiAo+Abur3D3y8xSZSTMpD4e0Kn3UQ9nKw/2WWKWslN"
                        "jKyzsBRSHv0jdVgg7KjtxoKAYNu/PbH4WCv2bcX+2nz8jxxDg2IOS/A6I3D3pha9Q/FX0MMPYDKwKWw4TZ83P"
                        "sZQvGWkW37TKaiGHFUpRfpuL/W8gHVD0ZJo8cK+WBxQsG5CujHlyifMQPBGmKiFW8IeHS2evKzPAqIUlUTUA/"
                        ...
                        "IamRoles": [
                            {
                                "IamRoleArn": "arn:aws:iam::529010877102:role/service-role/AmazonRedshift-CommandsAccessRole-20211209T063611",
                                "ApplyStatus": "in-sync",
                            }
                        ],
                        "MaintenanceTrackName": "current",
                        ...
                        "NextMaintenanceWindowStartTime": "datetime.datetime(2022, 2, 16, 8, 30, tzinfo=tzlocal())",
                        "AvailabilityZoneRelocationStatus": "disabled",
                        "ClusterNamespaceArn": "arn:aws:redshift:us-east-2:529010877102:"
                        "namespace:95b46b68-0afa-4ca9-baf2-b6bf714431bc",
                        "TotalStorageCapacityInMegaBytes": 256000000,
                        "AquaConfiguration": {
                            "AquaStatus": "disabled",
                            "AquaConfigurationStatus": "auto",
    ...
    # Unit test when use_fips and require_ssl is set to true, but parameter list is not synced. -- GHERKIN Scenario 4
    def test_scenario_5(self):
                ...
                "Clusters": [
                    {
                        ...
                        "ClusterParameterGroups": [
                            {
                                "ParameterGroupName": "myparametergroup",
                                "ParameterApplyStatus": "not-synced",
                                "ClusterParameterStatusList": [
                                    {
                                        "ParameterName": "use_fips_ssl",
                                        "ParameterApplyStatus": "not-synced",
                        ...
                        "PubliclyAccessible": False,
                        "Encrypted": False,
                        "ClusterPublicKey": "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABAQCanvmYtbNIGA5PiAY4rF6ppg1wR3QY0f860EPUpRSaoc07"
                        "UHOV4S2QLk21m5KEQm15rTE6dxVWrkXBzNabgdAsuiAo+Abur3D3y8xSZSTMpD4e0Kn3UQ9nKw/2WWKWslNj"
                        "KyzsBRSHv0jdVgg7KjtxoKAYNu/PbH4WCv2bcX+2nz8jxxDg2IOS/A6I3D3pha9Q/FX0MMPYDKwKWw4TZ83P"
                        "sZQvGWkW37TKaiGHFUpRfpuL/W8gHVD0ZJo8cK+WBxQsG5CujHlyifMQPBGmKiFW8IeHS2evKzPAqIUlUTUA"
                        "/t8t7EeCw5rnby8raUj7qWbeGqJ55d9CjcndHgaY5TZV Amazon-Redshift\n",
                        "ClusterNodes": [
                            {
                        ...
                        "NextMaintenanceWindowStartTime": "datetime.datetime(2022, 2, 16, 8, 30, tzinfo=tzlocal())",
                        "AvailabilityZoneRelocationStatus": "disabled",
                        "ClusterNamespaceArn": "arn:aws:redshift:us-east-2:529010877102:namespace:95b46b68-0afa-4ca9-baf2-b6bf714431bc",
                        "TotalStorageCapacityInMegaBytes": 256000000,
                        "AquaConfiguration": {
                            "AquaStatus": "disabled",
                            "AquaConfigurationStatus": "auto",
        ...
        parameters = {
            "Parameters": [
                ...
                },
                {
                    "ParameterName": "query_group",
                    "ParameterValue": "default",
                    "Description": "This parameter applies a user-defined label to a group of queries that are run "
        ...
        expected_response = [
            build_expected_response(
                "NON_COMPLIANT",
                "redshift-cluster-1",
                annotation="SSL is not enforced for the cluster. Make sure to "
                "enable require_ssl by setting it to true prior to "
                "forcing FIPS and ensure the parameters are in sync.",
            )
        ]
        assert_successful_evaluation(self, response, expected_response)
...
def build_lambda_scheduled_event(rule_parameters=None):
    event_to_return = {
        "version": "1.0",
        "invokingEvent": '{"awsAccountId":"123456789012","notificationCreationTime":"2022-02-15T12:03:0'
        '7.654Z","messageType":"ScheduledNotification","recordVersion":"1.0"}',
        "ruleParameters": "{}",
        "resultToken": "test",
        "eventLeftScope": False,
        "executionRoleArn": "arn:aws:iam::123456789012:role/aws-service-role/config.amazonaws.com/"
        "AWSServiceRoleForConfig",
        "configRuleArn": "arn:aws:config:us-east-2:123456789012:config-rule/config-rule-agdafb",
        "configRuleName": "periodic-fips",
        "configRuleId": "config-rule-agdafb",
        "accountId": "123456789012",
    }
    return event_to_return
