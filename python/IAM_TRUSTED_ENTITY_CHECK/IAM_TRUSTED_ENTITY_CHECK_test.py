...
RULE = __import__('IAM_TRUSTED_ENTITY_CHECK')
...
class ComplianceTest(unittest.TestCase):
    ...
    def test_scenario_1(self):
        ...
        IAM_CLIENT_MOCK.list_roles = MagicMock(return_value=list_roles_return)
        resp_expected = []
        response = RULE.lambda_handler(build_lambda_scheduled_event(), {})
        resp_expected.append(build_expected_response('NOT_APPLICABLE', '123456789012', compliance_resource_type='AWS::IAM::Role'))
    ...
    def test_scenario_2(self):
        ...
        list_roles_return = {'Roles': [
            {
                'RoleId': 'ABCDEFGHIJKL123456789',
                'AssumeRolePolicyDocument': {
                    'Version': '2012-10-17',
                    'Statement': [
                        {'Sid': '', 'Effect': 'Allow', 'Principal': {'AWS': 'arn:aws:iam::123456789012:root'}, 'Action': 'sts:AssumeRole'}
                    ]
                }
            }
        ]}
        ...
        resp_expected = []
        response = RULE.lambda_handler(build_lambda_scheduled_event(), {})
        resp_expected.append(build_expected_response('NON_COMPLIANT', 'ABCDEFGHIJKL123456789', compliance_resource_type='AWS::IAM::Role'))
        assert_successful_evaluation(self, response, resp_expected)
    ...
    def test_scenario_4(self):
        ...
        resp_expected = []
        response = RULE.lambda_handler(build_lambda_scheduled_event(), {})
        resp_expected.append(build_expected_response('COMPLIANT', 'ABCDEFGHIJKL123456789', compliance_resource_type='AWS::IAM::Role'))
        assert_successful_evaluation(self, response, resp_expected)
                ...
                'AssumeRolePolicyDocument': {
                    ...
                    'Statement': [
                        ...
                        },
                        {
                            ...
                            'Principal': {
                                'AWS': [
                                    'arn:aws:iam::123456789012:user/test-user3',
                                    'arn:aws:iam::123456789012:root'
                                ]},
                            'Action': 'sts:AssumeRole'
                        }
    ...
    def test_scenario_6(self):
        ...
        response = RULE.lambda_handler(build_lambda_scheduled_event(), {})
        resp_expected.append(build_expected_response('COMPLIANT', 'ABCDEFGHIJKL123456789', compliance_resource_type='AWS::IAM::Role'))
        resp_expected.append(build_expected_response('NON_COMPLIANT', 'ZYXWVUTSRQPO123456789', compliance_resource_type='AWS::IAM::Role'))
